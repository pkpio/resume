...
\section{Awards, Publications \& Talks}
	\begin{entrylist}
        \entry
            ...
            {\emph{Presented our work on how we managed to reduce SwiftKey's download size by 50\%, and install size by 40\%}}
        \entry
            {Speaker}
            {Android App size reduction}{Londroid, Facebook London 2019}
            {}
        \entry
            {Publication}
